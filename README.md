...
* Renamed the server to AD-DC-TXHQ <img width="748" height="581" alt="ServerName_IPadd" src="https://github.com/user-attachments/assets/d2a4f28b-90df-44a3-8bd5-b91b00803f37" />
* Configured a static IP address (`192.168.10.10`) and configured DNS to point to itself to prepare it for the role as primary DNS. <img width="400" height="457" alt="image" src="https://github.com/user-attachments/assets/4c9a5352-db8b-4694-87b7-d19b6868bbd0" />
* Promoted the server to a Domain Controller, establishing the root domain: `TXHQ\Administrator`. <img width="783" height="679" alt="image" src="https://github.com/user-attachments/assets/e7b70768-9196-4ba5-b7e3-e4f046dae173" /> <img width="470" height="357" alt="image" src="https://github.com/user-attachments/assets/f2fc9959-f4a4-448b-bf68-bc4c2e790e91" />
